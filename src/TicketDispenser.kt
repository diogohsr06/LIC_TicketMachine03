...
fun main() {
    ...
    println("${Miscellaneous.CYAN}${Miscellaneous.BOLD}■ Write the data you want to be sent")
    println("${Miscellaneous.YELLOW}${Miscellaneous.BOLD}■ Data is recommended to be written on binary for better understanding")
    ...
    println("=============================================================================")
    while (true) {
        print("${Miscellaneous.GREEN}${Miscellaneous.BOLD}RoundTrip:${Miscellaneous.GREEN} ")
        val rt = readln().toBoolean()
        print("${Miscellaneous.GREEN}${Miscellaneous.BOLD}Origin:${Miscellaneous.GREEN} ")
        val origin = readln()
        print("${Miscellaneous.GREEN}${Miscellaneous.BOLD}Destination:${Miscellaneous.GREEN} ")
        ...
        println("${Miscellaneous.GREEN}${Miscellaneous.BOLD}■ Sending...")
        Time.sleep(3000)
        TicketDispenser.lowerPrt(false, 0, 0)
        print("${Miscellaneous.YELLOW}${Miscellaneous.BOLD}Continue [y/n]?${Miscellaneous.YELLOW} ")
        val next = readln()
