...
architecture arch_adder5 of Adder5 is
--Full Adder
...
--Sinais intermedios
signal carry : std_logic_vector(4 downto 1);		--Propagaçao de carry
...
U4: FullAdder port map (A => A(3), B => B(3), Ci => carry(3), S => S(3), Co => carry(4));		--Instanciaçao do full adder 4
U5: FullAdder port map (A => A(4), B => B(4), Ci => carry(4), S => S(4), Co => CO);				--Instanciaçao do full adder 5
